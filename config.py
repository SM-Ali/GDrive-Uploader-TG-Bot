...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '2112033491:AAGl5ZU6SBL1nEWHE2PwJ-zAUC2nEJBO6m8' # Get it from https://t.me/BotFather
    APP_ID = '9927614' # Get it from my.telegram.org/apps
    API_HASH = 'f071ec00bb6ad4a3c8d0f10d3993f6d3' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://brdiofgwltezqu:0853a0959d440f6f9cdc77ca258d24656fe9868e3e56a518aae573d52edfcd23@ec2-18-213-133-45.compute-1.amazonaws.com:5432/dt1c33poeb8c8' # SQL Database URL / Heroku Postgres URL
