...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5281126030:AAH_ZZsD1qEgjxffbGyYbaHVxbeu_7qdbVM' # Get it from https://t.me/BotFather
    APP_ID = '14852405' # Get it from my.telegram.org/apps
    API_HASH = '974ce6b000d82a2bfe0c661a1b060ac1' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://pxlpzgrmujcohs:61f2a8645d65f6eb53926949dda1c9b674d71bdf5fe7bc601b4cbba5ad1d4e11@ec2-23-23-182-238.compute-1.amazonaws.com:5432/dfhded4ocd455qm:5432/dt1c33poeb8c8' # SQL Database URL / Heroku Postgres URL
